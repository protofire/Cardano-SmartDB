import { LucidLUCID_NETWORK_MAINNET_NAME, LucidLUCID_NETWORK_PREPROD_NAME, LucidLUCID_NETWORK_PREVIEW_NAME, NextApiRequestAuthenticated, console_error, console_log, globalSettings, initApiRequestWithContext, isEmulator, showData } from 'smart-db/backEnd';
